      ...
      .map do |visit|
        {
          ...
          origin: visit.user_id.present? ? visit.user.email : [ visit.referrer_host || "direct", visit.utm_campaign, visit.utm_medium, visit.utm_content, visit.utm_term ].compact.join(", "),

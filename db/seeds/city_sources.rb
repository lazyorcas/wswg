...
CITY_SOURCES_ATTRIBUTES.each do |attrs_array|
  ...
  if city_source.new_record?
    ...
    city_source.attributes = attrs.slice(*CitySource.column_names)
    city_source.save!
  end
end
